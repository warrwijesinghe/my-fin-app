...
- Fixed Asset accounts hold land and other long-term assets. Create a Fixed Asset account (for example, `Land – Kandy`), then use **Transfer / asset purchase** from cash, bank, or loan into that account for the purchase price and direct acquisition costs such as documentation, valuation, registration, and survey fees. These postings are excluded from Household expenses and Business profit, excluded from available cash, and included in net worth.
- **Shared cash** is for money permanently held by your partner for expenses; it is not a loan. Use **Family loans** for repayable cash: an advance moves money from the lender's selected cash/bank/savings account into the borrower's selected account, while a partial or full repayment moves money back and reduces the outstanding loan. Neither side is income or expense.
